...
close.MouseButton1Click:Connect(function()
	...
	icon.Name = "Icon"
	icon.Image = "rbxassetid://6031280882" -- fingerprint icon
	...
	icon.Parent = b
b.MouseEnter:Connect(function() icon.ImageTransparency = 0 end)
b.MouseLeave:Connect(function() icon.ImageTransparency = 0.15 end)
